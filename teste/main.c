...
int main() {
    ...
    inicializaColecao(filmes, &totalFilmes);
    ...
    while(1) {
        ...
        if(strcmp(opcao, "0") == 0) {
            ...
            if (strcmp(opcao, "0") == 0) {
                char confirmar[4]; /* string em vez de char porque assim o utilizador pode escrever "sim" ou "s" */
            ...
            adicionaFilme(filmes, &totalFilmes, novoFilme);
